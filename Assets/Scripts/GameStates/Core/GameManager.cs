...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField, Foldout("R�f�rences"), Required] private DeckManager deckManager;
    [SerializeField, Foldout("R�f�rences"), Required] private DominoSpawner dominoSpawner;
    [SerializeField, Foldout("R�f�rences"), Required] private DominoMovementController dominoMouvement;
    ...
    //public Action OnGameLost; // action quand un domino est plac� en haut de la grille
    //public Action OnWin;
    public Action<GameState> OnStateChanged; // Nouvelle action principale pour les g�rer les states 
